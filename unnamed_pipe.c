...
/* The output should look like this (when char *msg = "Do not wait for me";)

Parent: I have a message from child - Do not wait for me
Okay, I am not waiting. Bye
Child: Parent passed away. I am an orphan.
Child: Parent passed away. I am an orphan.
Child: Parent passed away. I am an orphan.
Child: Parent passed away. I am an orphan.
Child: Parent passed away. I am an orphan.
...
The output should look like this (when char *msg = "Wait for me";)
Or any message (excluding "Do not wait for me")

Parent: I have a message from child - Wait for me
Parent: Waiting...
Child: Parent is waiting for me.
Parent: Waiting...
Child: Parent is waiting for me.
Child: Parent is waiting for me.
Parent: Waiting...
